...
def _test_books_destination(current_values: dict[str, Any] | None = None) -> dict[str, Any]:
    return _test_folder_destination(current_values=current_values, is_audiobook=False)


def _test_audiobook_destination(current_values: dict[str, Any] | None = None) -> dict[str, Any]:
...
def download_settings() -> list[SettingsField]:
    ...
    return [
        ...
        ActionButton(
            ...
            callback=_test_books_destination,
            show_when={
                "field": "BOOKS_OUTPUT_MODE",
                "value": "folder",
            },
        ...
        ActionButton(
            ...
            callback=_test_audiobook_destination,
            universal_only=True,
        ),
        SelectField(
