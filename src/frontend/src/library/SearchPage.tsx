        ...
        <div className="mt-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
            {books.map((book) => (
              <article
                key={book.id}
                className="animate-pop-up flex min-h-36 overflow-hidden rounded-xl bg-(--bg-soft) transition duration-200 hover:-translate-y-0.5 hover:bg-(--hover-surface) hover:shadow-md focus-within:-translate-y-0.5 focus-within:bg-(--hover-surface) focus-within:shadow-md"
              >
                <div className="w-28 shrink-0">
                  <Cover book={book} />
                </div>
                <div className="flex min-w-0 flex-1 flex-col p-3">
                  <h2 className="break-words leading-tight font-semibold">
                    {book.title || 'Untitled'}
                  </h2>
