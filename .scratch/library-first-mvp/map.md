...
- **Next-session entry point**: read this map, then claim the first open unblocked ticket. At this point that is ticket 17; it includes the branch, PR, known failures, constraints, and verification required to resume without conversation context.
